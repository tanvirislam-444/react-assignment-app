    ...
    <footer className="bg-[#ffffff] text-[#0F172A] border-t border-slate-200 mt-20">
      <div className="mx-auto max-w-7xl px-6 py-12 ">
        <div className="grid grid-cols-5 ">
          <div className="col-span-5 lg:col-span-2 flex flex-col items-center lg:items-start">
            <img src={Logo} alt="" />
            <p className="mt-4 lg:w-110 w-110 text-center lg:text-start text-slate-400">
