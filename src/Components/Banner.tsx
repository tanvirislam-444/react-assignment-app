...
const Banner = () => {
    return (
        <div className='flex md:ml-30 justify-center items-center min-h-100 my-6 mx-5 flex-col md:flex-row'>
            ...
            <h1 className='font-bold text-5xl w-full md:text-5xl md:w-2xl'>Build Your Ideal <span className='bg-[linear-gradient(90deg,#FF5722_0%,#D81B7E_50%,#7C3AED_100%)] bg-clip-text text-transparent'>Development Stack</span></h1>
